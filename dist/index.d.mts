...
import { Queries, Row as Row$1, Store } from 'tinybase';
...
declare class MicroStore {
  ...
  ): InterpreterReturnValue | undefined;
  pushRecords(
    type: string,
    data: RawRecord[],
    method: MethodType,
...
export {
  ...
  useMicroStore,
  useReactive,
  type CallableWithReturn,
  type ConventionalSchema,
  type ConventionalSchemas,
  type FieldTransform,
  type FieldTransforms,
  type InterpretableWithReturn,
  type InterpreterReturnValue,
  type InterpreterTypedBatch,
  type MethodType,
  type MicroStoreCellSchema,
  type MicrostoreInterpreter,
  type MicroStoreOptions,
  type MicroStoreSchema,
  type MicroStoreSchemas,
  type RawRecord,
  type RawRow,
  type RecordCallableWithReturn,
  type RecordTransform,
  type RecordTransforms,
  type RowCallableWithReturn
};
