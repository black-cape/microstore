'use strict';
var emberInflector = require('ember-inflector'),
  lodashEs = require('lodash-es'),
  tinybase = require('tinybase'),
  react = require('react'),
  uiReact = require('tinybase/ui-react'),
  ...
  return (
    o !== void 0 &&
      Object.keys(o).forEach((t) => {
        ...
        if (t !== 'meta') {
          let n = [],
            c = lodashEs.camelCase(emberInflector.singularize(t));
          (lodashEs.isArray(i)
            ? i.forEach((a) => {
                n.push(a);
              })
  ...
  y = class {
    constructor(e) {
      ...
      ((this.primaryKeys = {}),
        ...
        (this.store = tinybase.createStore()),
        this.store.setTablesSchema(this.transformSchemas()),
        (this.queries = tinybase.createQueries(this.store)));
    }
    transformSchemas() {
      let e = {};
      return (
        Object.keys(this.schemas).forEach((r) => {
          if (
            ...
            Object.keys(this.schemas[r]).forEach((s) => {
              if (
                ((e[r][s] = lodashEs.omit(this.schemas[r][s], N)),
    ...
    pushRecords(e, r, s, t = {}) {
      let i = this.getRecordTransform(e),
        n = lodashEs.camelCase(emberInflector.pluralize(e));
...
function g() {
  return react.useContext(w);
}
function J(o) {
  let e = react.useMemo(() => o.store, [o]);
  return jsxRuntime.jsx(w.Provider, {
    value: e,
    children: jsxRuntime.jsx(uiReact.Provider, { store: e.getStore(), queries: e.getQueries(), children: o.children })
  });
}
function U(o, e) {
...
function X(o, e) {
  ...
  let [i, n] = react.useState(crypto.randomUUID()),
    c = uiReact.useQueries(),
    a = uiReact.useResultTable(i, c),
    [d, E] = react.useState(''),
    u = react.useRef('');
  react.useEffect(() => {
    if (c) {
...
exports.MicroStore = y;
exports.MicroStoreProvider = J;
exports.RESTInterpreter = l;
exports.json = p;
exports.useMicroStore = g;
exports.useReactive = X; //# sourceMappingURL=index.js.map
